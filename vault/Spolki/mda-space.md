---
company_id: "mda-space"
nazwa_kanoniczna: "MDA Space Ltd."
ticker: "MDA"
glowny_listing: "XTSE"
isin: ""
status: "notowana"
...
tematy: ["fizyka-orbitalna-orbity-i-operacje", "niezawodnosc-serwisowanie-i-cykl-zycia-sprzetu"]
...
```mermaid
xychart-beta
    title "Przychody MDA Space (CAD mln)"
    x-axis ["FY2024", "FY2025"]
    y-axis "CAD mln" 0 --> 1800
    bar [1080, 1633]
```
...
```mermaid
pie title Struktura przychodow wg segmentow FY2025 (% przychodow)
    "Satellite Systems" : 68
    "Robotics & Space Operations" : 19
    "Geointelligence" : 13
```
...
```mermaid
pie title Koncentracja odbiorcow FY2025 (% przychodow)
    "Trzej najwieksi klienci (>10% kazdy)" : 77.6
    "Pozostali" : 22.4
```
...
```mermaid
xychart-beta
    title "Backlog MDA Space (CAD mln)"
    x-axis ["31.03.2025", "31.12.2025", "31.03.2026"]
    y-axis "CAD mln" 0 --> 5000
    bar [4838, 4013, 3693]
```
