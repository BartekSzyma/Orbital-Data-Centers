...
ekspozycja_gpw_eu_nota: "Notowana na Euronext Paris; przez Airbus Defence and Space + Tesat-Spacecom dominuje w EU w PV, optyce i busach."
tematy: ["fizyka-orbitalna-orbity-i-operacje", "energetyka-kosmiczna-i-fotowoltaika-orbitalna", "chlodzenie-i-radiacyjne-odprowadzanie-ciepla", "lacznosc-optyczne-isl-downlink-i-latencja", "niezawodnosc-serwisowanie-i-cykl-zycia-sprzetu"]
...
To te same kompromisy doboru orbity, które rozwija wątek [[03 - fizyka-orbitalna-orbity-i-operacje#Trade-off orbit: LEO vs SSO dawn-dusk vs MEO vs GEO]], a ograniczenia wynoszenia gotowych modułów kontra montaż na orbicie omawia [[03 - fizyka-orbitalna-orbity-i-operacje#Montaż on-orbit / in-space assembly vs wynoszenie gotowych modułów, ograniczenie fairingu]].
...
![](assets/airbus-1-Sparkwing-artist-view-copyright.jpg)
...
Mechanizmy decydujące o gęstości mocy i przeliczeniu na megawaty rozwija [[04 - energetyka-kosmiczna-i-fotowoltaika-orbitalna#Gęstość masowa: W/kg, masa/m2 i przeliczenie "200 MW"]], a ograniczenia degradacji ogniw w środowisku radiacyjnym - [[04 - energetyka-kosmiczna-i-fotowoltaika-orbitalna#Degradacja PV od promieniowania: BOL vs EOL]].
...
Dlaczego w próżni liczy się wyłącznie promieniowanie, wyjaśnia [[05 - chlodzenie-i-radiacyjne-odprowadzanie-ciepla#Mechanizm: dlaczego w próżni liczy się tylko promieniowanie]], a zastosowane technologie pętli i radiatorów rozwija [[05 - chlodzenie-i-radiacyjne-odprowadzanie-ciepla#Technologie: heat pipes, pętle, układy dwufazowe i radiatory rozkładane]].
...
Roadmapy laserowych łączy międzysatelitarnych rozwija [[07 - lacznosc-optyczne-isl-downlink-i-latencja#Optyczne łącza międzysatelitarne (laser ISL) i roadmapy Tbps]], a kompromisy między downlinkiem RF a optycznym - [[07 - lacznosc-optyczne-isl-downlink-i-latencja#Downlink do Ziemi: RF Ka/V band kontra optyczne stacje naziemne i wpływ chmur]].
...
Dlaczego brak napraw in-situ wymusza model robotyczny, rozwija [[08 - niezawodnosc-serwisowanie-i-cykl-zycia-sprzetu#Brak napraw in-situ a robotyczna obsługa (Northrop Grumman MEV i następcy)]], a napięcie między tempem prawa Moore'a a żywotnością platformy - [[08 - niezawodnosc-serwisowanie-i-cykl-zycia-sprzetu#Starzenie technologiczne (prawo Moore'a) szybsze niż żywotność platformy - problem ekonomiczny]].
